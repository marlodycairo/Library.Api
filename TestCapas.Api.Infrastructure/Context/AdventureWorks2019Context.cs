...
using TestCapas.Api.Infrastructure.Entities;
...
namespace TestCapas.Api.Infrastructure.Context
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<Person2> Person2s { get; set; }
        public virtual DbSet<Person3> Person3s { get; set; }
        ...
        public virtual DbSet<Product3> Product3s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=MARLODY\\SQLEXPRESS;Initial Catalog=AdventureWorks2019;Integrated Security=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.PagosId)
                    .HasName("PK__Pagos__1F01FDAAB886F661");

                entity.ToTable("Pagos", "Person");

                entity.Property(e => e.PagosId).HasColumnName("PagosID");

                entity.Property(e => e.CustomerId).HasColumnName("CustomerID");

                entity.Property(e => e.Saldo).HasComputedColumnSql("([TotalDeuda]-[Abono])", false);
            });
            ...
            modelBuilder.Entity<Person2>(entity =>
            {
                entity.HasKey(e => e.BusinessEntityId)
                    .HasName("PK__Person2__88984337A01A8288");

                entity.ToTable("Person2", "Person");
            ...
            modelBuilder.Entity<Person3>(entity =>
            {
                entity.HasKey(e => e.BusinessEntityId)
                    .HasName("PK__Person3__8898433785E0F952");

                entity.ToTable("Person3", "Person");
            ...
            modelBuilder.Entity<Product2>(entity =>
            {
                entity.HasKey(e => e.ProductId)
                    .HasName("PK__Product2__2D10D16AEAFA9724");

                entity.ToTable("Product2", "Production");
            ...
            {
                entity.HasKey(e => e.ProductId)
                    .HasName("PK__Product3__B40CC6EDB318B44D");

                entity.ToTable("Product3", "Person");
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                entity.HasKey(e => e.SalesId)
                    .HasName("PK__Sales__C952FB12971E8EE9");

                entity.ToTable("Sales", "Person");
                ...
                entity.Property(e => e.Subtotal).HasComputedColumnSql("([Price]*[Quantity])", false);
            });
